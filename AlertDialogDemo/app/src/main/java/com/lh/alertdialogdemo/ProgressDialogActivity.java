package com.lh.alertdialogdemo;
...
public class ProgressDialogActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private Button btn_pd1;
    private Button btn_pd2;
    private Button btn_pd3;
    ...
    private void bindViews() {
        btn_pd1 = (Button) findViewById(R.id.btn_pd1);
        btn_pd2 = (Button) findViewById(R.id.btn_pd2);
        btn_pd3 = (Button) findViewById(R.id.btn_pd3);
        btn_pd1.setOnClickListener(this);
        btn_pd2.setOnClickListener(this);
        btn_pd3.setOnClickListener(this);
    }
